...
--
-- Host: localhost
-- Generation Time: Apr 05, 2012 at 11:10 PM
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.63190001, 1, '2012-04-05 18:38:41'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2012-04-05 22:31:46'),
(3, 'Euro', 'EUR', '', '€', '2', 0.76580000, 1, '2012-04-05 18:38:41');
...
(1, 0, 'greg', 'pardo', 'gregpardo@knights.ucf.edu', '4074864686', '', '89bbc310e3d86cc0d2bb7459b3906510', 'a:0:{}', '', 0, 1, 8, '127.0.0.1', 1, 1, '', '2012-04-05 16:25:01');
...
(49, 'SAM1', '', '', '', 0, 8, 'data/samsung_tab_1.jpg', 0, 1, '199.9900', 0, 9, '2011-04-25', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2011-04-26 08:57:34', '2011-09-30 01:06:23', 2);
...
CREATE TABLE IF NOT EXISTS `product_tag` (
  ...
  KEY `tag` (`tag`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=343 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=24638 ;
...
(24635, 0, 'config', 'config_error_log', '1', 0),
(24634, 0, 'config', 'config_error_display', '1', 0),
(24632, 0, 'config', 'config_encryption', '12345', 0),
(24633, 0, 'config', 'config_compression', '0', 0),
(24630, 0, 'config', 'config_seo_url', '0', 0),
(24631, 0, 'config', 'config_maintenance', '0', 0),
(24629, 0, 'config', 'config_use_ssl', '0', 0),
(24627, 0, 'config', 'config_fraud_score', '', 0),
(13801, 0, 'coupon', 'coupon_sort_order', '4', 0),
(13800, 0, 'coupon', 'coupon_status', '1', 0),
(24628, 0, 'config', 'config_fraud_status_id', '7', 0),
(24626, 0, 'config', 'config_fraud_key', '', 0),
(24625, 0, 'config', 'config_fraud_detection', '0', 0),
...
(24624, 0, 'config', 'config_alert_emails', '', 0),
(24623, 0, 'config', 'config_account_mail', '0', 0),
(24622, 0, 'config', 'config_alert_mail', '0', 0),
(24621, 0, 'config', 'config_smtp_timeout', '5', 0),
(24620, 0, 'config', 'config_smtp_port', '25', 0),
(24619, 0, 'config', 'config_smtp_password', '', 0),
(24618, 0, 'config', 'config_smtp_username', '', 0),
(18432, 0, 'reward', 'reward_sort_order', '2', 0),
(18431, 0, 'reward', 'reward_status', '1', 0),
(24617, 0, 'config', 'config_smtp_host', '', 0),
...
(24616, 0, 'config', 'config_mail_parameter', '', 0),
(24615, 0, 'config', 'config_mail_protocol', 'mail', 0),
...
(24614, 0, 'config', 'config_image_cart_height', '47', 0),
(24613, 0, 'config', 'config_image_cart_width', '47', 0),
(24612, 0, 'config', 'config_image_wishlist_height', '47', 0),
(24611, 0, 'config', 'config_image_wishlist_width', '47', 0),
(24610, 0, 'config', 'config_image_compare_height', '90', 0),
(24608, 0, 'config', 'config_image_related_height', '80', 0),
(24609, 0, 'config', 'config_image_compare_width', '90', 0),
(24606, 0, 'config', 'config_image_additional_height', '74', 0),
(24607, 0, 'config', 'config_image_related_width', '80', 0),
(24605, 0, 'config', 'config_image_additional_width', '74', 0),
(24604, 0, 'config', 'config_image_product_height', '80', 0),
(24602, 0, 'config', 'config_image_popup_height', '500', 0),
(24603, 0, 'config', 'config_image_product_width', '80', 0),
(24601, 0, 'config', 'config_image_popup_width', '500', 0),
(24600, 0, 'config', 'config_image_thumb_height', '228', 0),
(24599, 0, 'config', 'config_image_thumb_width', '228', 0),
(24598, 0, 'config', 'config_image_category_height', '80', 0),
(24597, 0, 'config', 'config_image_category_width', '80', 0),
(24594, 0, 'config', 'config_cart_weight', '1', 0),
(24595, 0, 'config', 'config_logo', 'data/EN_logo.png', 0),
(24596, 0, 'config', 'config_icon', 'data/cart.png', 0),
(16017, 0, 'voucher', 'voucher_sort_order', '8', 0),
(16016, 0, 'voucher', 'voucher_status', '1', 0),
(24592, 0, 'config', 'config_download', '1', 0),
(24593, 0, 'config', 'config_upload_allowed', 'jpg, JPG, jpeg, gif, png, txt', 0),
(24591, 0, 'config', 'config_review_status', '1', 0),
(24590, 0, 'config', 'config_return_status_id', '2', 0),
(24588, 0, 'config', 'config_order_status_id', '1', 0),
(19410, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(19409, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(24589, 0, 'config', 'config_complete_status_id', '5', 0),
...
(24587, 0, 'config', 'config_stock_status_id', '5', 0),
(24586, 0, 'config', 'config_stock_checkout', '0', 0),
(24585, 0, 'config', 'config_stock_warning', '0', 0),
(24584, 0, 'config', 'config_stock_display', '0', 0),
(24581, 0, 'config', 'config_checkout_id', '5', 0),
(24582, 0, 'config', 'config_affiliate_id', '4', 0),
(24583, 0, 'config', 'config_commission', '5', 0),
(24580, 0, 'config', 'config_account_id', '3', 0),
(24579, 0, 'config', 'config_guest_checkout', '1', 0),
(24578, 0, 'config', 'config_customer_approval', '0', 0),
(24577, 0, 'config', 'config_customer_price', '0', 0),
(24576, 0, 'config', 'config_customer_group_id', '8', 0),
(24575, 0, 'config', 'config_order_edit', '100', 0),
(24574, 0, 'config', 'config_invoice_prefix', 'INV-2011-00', 0),
(24573, 0, 'config', 'config_tax_customer', 'shipping', 0),
(24571, 0, 'config', 'config_tax', '1', 0),
(24572, 0, 'config', 'config_tax_default', 'shipping', 0),
(24570, 0, 'config', 'config_admin_limit', '20', 0),
(24569, 0, 'config', 'config_catalog_limit', '15', 0),
(24568, 0, 'config', 'config_weight_class_id', '5', 0),
(24567, 0, 'config', 'config_length_class_id', '3', 0),
(24566, 0, 'config', 'config_currency_auto', '1', 0),
(24565, 0, 'config', 'config_currency', 'USD', 0),
(24564, 0, 'config', 'config_admin_language', 'en', 0),
(24562, 0, 'config', 'config_zone_id', '3630', 0),
(24563, 0, 'config', 'config_language', 'en', 0),
(24561, 0, 'config', 'config_country_id', '223', 0),
(24560, 0, 'config', 'config_layout_id', '4', 0),
(24559, 0, 'config', 'config_template', 'edunation', 0),
(24558, 0, 'config', 'config_meta_description', 'All your educational supply needs', 0),
(24557, 0, 'config', 'config_title', 'eduNation', 0),
(24556, 0, 'config', 'config_fax', '', 0),
(24555, 0, 'config', 'config_telephone', '123456789', 0),
(24554, 0, 'config', 'config_email', 'gregpardo@knights.ucf.edu', 0),
(24553, 0, 'config', 'config_address', 'Address 1', 0),
(24552, 0, 'config', 'config_owner', 'Your Name', 0),
(24551, 0, 'config', 'config_name', 'Edunation', 0),
(24636, 0, 'config', 'config_error_filename', 'error.txt', 0),
(24637, 0, 'config', 'config_google_analytics', '', 0);
...
(1, 1, 'admin', '44b121e2a3208c259793abd48620ff2e', '', '', 'gregpardo@knights.ucf.edu', '', '127.0.0.1', 1, '2012-04-05 14:38:18');
